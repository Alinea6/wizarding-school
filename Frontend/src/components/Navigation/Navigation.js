            ...
            <nav style={{ display: 'grid'}}>
                <Container className='ba bw2'>
                    <Row className='pa0'>
                        ...
                        <Col className='pa0 ba bg-black hover: dim'>
                            <p className='tc f4 light-silver link pointer'>{'Pokój Wspólny'}</p>
                        </Col>
                        <Col className='pa0 ba bg-black hover: dim'>
                    ...
                    <Row className='pa0'>
                        ...
                        <Col className='pa0 ba bg-black hover: dim'>
                            <p className='tc f4 light-silver link pointer'>{'Izba Pamięci'}</p>
                        </Col>
                    </Row>
                    <Row className='pa0'>
                        <Col className='pa0 ba bg-black hover: dim'>
                        ...
                        <Col onClick={this.onLoggedOut} className='pa0 ba bg-black hover: dim'>
