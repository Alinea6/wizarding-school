            ...
            <Container className='ba bw2' style={{display: 'grid'}}>
                <Row className='pa0'>
                    <Col className=' pa0 ba bg-black'>
                        <p className='tc f4 light-silver link pointer'>{this.props.user.login}</p>
                    </Col>
                </Row>
                <Row className='pa0'>
                ...
                <Row className='pa0'>
                    <Col xs={6} sm={6} md={6} lg={6} xl={6} className='pa0 bg-black'>
                        <ProgressBar striped variant="danger" now={this.state.healthPercentage} />
                    </Col>
                    <Col xs={6} sm={6} md={6} lg={6} xl={6} className='pa0 bg-black'>
                ...
                <Row className='pa0'>
                    <Col xs={6} sm={6} md={6} lg={6} xl={6} className='pa0 bg-black'>
                        <ProgressBar striped variant="success" now={this.state.actionPercentage} />
                    </Col>
                    <Col xs={6} sm={6} md={6} lg={6} xl={6} className='pa0 bg-black'>
